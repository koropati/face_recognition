...
from preprocessing import preprocessing_face_haar
...
def main():
	...
	preprocessing_face_haar(args.inputImage, args.outImage, args.scaleFactor, args.neighboor)

	######################################## RUN PROGRAM BY TYPE ################################################
	#
	# python preprocessing_image_haar.py -i "D:/PYTHON_PCD/dataset_01" -o "D:/PYTHON_PCD/dataset_out_haar" -s 1.3 -n 6
	# 
	#############################################################################################################
